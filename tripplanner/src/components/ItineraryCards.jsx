          ...
          <div className="p-6">
            <div className="space-y-4">
              {selectedDay.locations?.map((location, locIndex) => (
                <div
                  key={locIndex}
                  className="flex gap-4 p-4 rounded-xl transition-colors cursor-pointer location-card"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 mt-2 text-xs text-gray-500">
                      ...
                      {location.distance_from_previous &&
                        location.distance_from_previous !== "0.0 km" && (
                          <span className="flex items-center gap-1">
                            <svg
                              className="w-3 h-3"
                              fill="none"
                      ...
                      {location.travel_duration &&
                        location.travel_duration !== "0 min" && (
                          <span className="flex items-center gap-1">
                            <svg
                              className="w-3 h-3"
                              fill="none"
          ...
          <div className="p-6">
            <div className="grid gap-4">
              {hotels.slice(0, 3).map((hotel, index) => (
                <div
                  key={index}
                  className="flex gap-4 p-4 rounded-xl transition-colors cursor-pointer hotel-card"
                >
                  {/* Hotel image */}
                  <div className="flex-shrink-0">
                      ...
                      {hotel.pricing && (
                        <div className="text-right">
                          <div className="text-sm font-semibold text-gray-900">
                            ${hotel.pricing.range_min} - $
                            {hotel.pricing.range_max}
                          </div>

    ...
    <div className="mx-auto mt-3 w-full max-w-screen-2xl md:mt-14">
      ...
      <p className="mx-auto mt-10 max-w-3xl px-6 text-center text-base lg:px-12 lg:text-lg">
        ...
        <a
          ...
          href="https://tripplanner.ai/public-trips"
        >
          trip itineraries
        </a>{" "}
        crafted by our global travelers. Find your next adventure and share your
        own journey with fellow explorers.
      </p>
      <div className="mx-auto mt-12 flex max-w-6xl flex-col gap-5 px-6 md:flex-row lg:gap-12 lg:px-12">
        <div className="flex flex-auto flex-col gap-5 lg:gap-12">
          {inspirations.slice(0, 2).map((inspiration, index) => (
            <div
              key={index}
              className={`group relative items-end overflow-hidden rounded-xl md:rounded-3xl flex h-[15rem] max-w-[50rem] ${inspiration.heightClass}`}
                ...
                <div className="relative z-[22] flex h-full flex-col justify-between p-4 md:p-7 lg:p-8">
                  ...
                  <div className="flex items-center gap-2">
                    <img
                      ...
                      style={{ color: "transparent" }}
                      src={inspiration.user.avatarSrc}
                    />

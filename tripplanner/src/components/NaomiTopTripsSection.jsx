  ...
  const NaomiTopTripsSection = () => {
    const cards = [
      {
        image: mysoreImg,
        title: "Mysuru Majesty",
        text: "Palaces, silk markets, and dusky lamps — soak in royal grandeur with a relaxed city rhythm.",
      },
      {
        image: indiaImg,
        title: "Incredible India Mix",
        text: "A sampler of heritage, cuisine, and culture — perfect for first-timers looking to feel the vibe.",
      },
      {
        image: blrImg,
        title: "Bengaluru City Vibes",
        text: "Garden cafés, green boulevards, and buzzing tech streets — the perfect balance of modern and laid-back.",
      },
      {
        image: mumbai,
        title: "Mumbai Magic",
        text: "Sea breezes, street eats, and midnight lights — dive into the fast-paced charm of the Maximum City.",
      },
      {
        image: chennai,
        title: "Chennai Charm",
        text: "Temple bells, filter coffee, and Marina Beach sunsets — a soulful blend of tradition and sea breeze.",
      },
      {
        image: up,
        title: "Uttar Pradesh Heritage",
        text: "From the Taj’s timeless glow to Varanasi’s sacred ghats — journey through history, faith, and living culture.",
      },
    ];
          ...
          <div className="flex flex-col items-center gap-10 md:gap-12">
            <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
              ...
              <p className="mt-2 text-sm md:text-base text-gray-600">
                Your adventures, your story — design a postcard that’s uniquely for you.
              </p>
  ...
  export default NaomiTopTripsSection;
